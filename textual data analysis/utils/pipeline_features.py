...
def build_features(df_clean_path="../artifacts/reports/fact_removed_blank.xlsx", 
    ...
    dictionary_path = os.path.join(data_folder, "user_defined_dict/articut_user_defined_dict.json")
    ...
    print("3. 生成 Document-Term Matrix (BoW & TF-IDF)...")
    dtm, dtm_csr, doc_ids, vocab, delete_set = get_dtm_BoW(
        df_word_seg, custom_tokenizer, stop_word, delete_word, strip_phrase=True, model="BoW"
    )
